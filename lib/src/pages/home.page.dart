...
import 'package:peliculas/src/widges/card_swiper_widget.dart';
import 'package:peliculas/src/widges/movie_horizontal.dart';
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        StreamBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<List> snapshot) {
            if (snapshot.hasData) {
              return MovieHorizontal( peliculas: snapshot.data, siguientePaguina: peliculasProvider.getPopular, );
            } else {
